...
Window = Fluent:CreateWindow({
    Title = "TanPhat HUD",
    SubTitle="Cháu nào thấy lỗi liên hệ Facebook", 
    TabWidth=155, 
    Theme="Darker",
    Acrylic=false,
...
Button.Image = "rbxassetid://74881423016311"
...
Tabs.Info:AddButton({
        ...
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/xeZebKu9")) 
        end
})
Tabs.Info:AddButton({
    Title="TanPhat HUD",
    Description="TikTok",
    Callback=function()
        setclipboard(tostring("tiktok.com/@duongtanphat14072013"))
    end
})
Tabs.Info:AddButton({
    Title="Dương Phát",
    ...
    Callback=function()
        setclipboard(tostring("https://www.facebook.com/share/1GHHvc4EWV/"))
    end
})
Tabs.Info:AddParagraph({
    Title="Dương Tấn Phát",
    Content="Credits"
})
local executorName
